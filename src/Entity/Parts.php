...
class Parts
{
    ...
    public function isNalicie(): ?bool
    {
        return $this->nalicie;
    }

    public function setNalicie(bool $nalicie): static
    {
        $this->nalicie = $nalicie;
